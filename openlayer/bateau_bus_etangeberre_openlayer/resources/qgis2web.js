...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [851968.000000, 6249421.500000, 887161.500000, 6282371.000000],
            units: 'm'
        })
    })
});
...
map.getView().fit([849506.156280, 6248597.762500, 889623.343720, 6283194.737500], map.getSize());
    ...
    element: (() => {
        ...
        if (139 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cartographie des potentiels sites d\'implantation d\'embarcadères autour de l\'Etang de Berre pour le développement de lignes de bateaux bus. ';
            }
...
map.once('rendercomplete', function() {
  ...
  if (bottomAttributionUl) {
    ...
    <a href="https://www.crige-paca.org/">CRIGE PACA</a>`;
